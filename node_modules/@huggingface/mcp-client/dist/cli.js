...
function urlToServerConfig(urlStr, authToken) {
  ...
  const shouldIncludeToken = !!authToken && (hostname.endsWith(".hf.space") || hostname.endsWith("huggingface.co") || hostname === "localhost" || hostname === "127.0.0.1");
  if (type === "http") {
    return {
      type: "http",
      config: {
...
var SERVERS = [
  {
    ...
    args: [
      ...
      process.platform === "darwin" ? (0, import_node_path.join)((0, import_node_os.homedir)(), "Desktop") : (0, import_node_os.homedir)()
    ]
  },
  {
    // Playwright MCP
